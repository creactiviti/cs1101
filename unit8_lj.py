...
with open('my_family.json') as json_file:
    my_family = json.load(json_file)

# print()

with open('my_family_inverted.json','w') as json_file:
   json_file.write(json.dumps(invert_dict(my_family), indent=4))
